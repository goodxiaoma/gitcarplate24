...
#define CONFIG_MESH_RPL_COUNT_MIN              (10)
#define CONFIG_MESH_RPL_COUNT_DEF              (40)
...
// 配网发起者支持的配网设备节点个数
#define CONFIG_MESH_PROV_NODE_COUNT_DEF        (10)
...
#define APP_DBG(X...)                     \
  if(1)                                   \
  {                                       \
    printf("Communication Tests %s> ", __FUNCTION__); \
    printf(X);                            \
    printf("\n");                         \
  }
